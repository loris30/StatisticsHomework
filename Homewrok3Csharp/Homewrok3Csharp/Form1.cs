...
namespace Homewrok3Csharp
{
    ...
    {
        TextFieldParser parser = new TextFieldParser(@"C:\\Users\\loris\\Desktop\\antani.csv");
        TextFieldParser parser1 = new TextFieldParser(@"C:\\Users\\loris\\Desktop\\antani.csv");
        string[]? values = null;
        string[]? values1 = null;
